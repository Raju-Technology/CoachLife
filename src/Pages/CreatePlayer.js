...
function CreatePlayer() {
    ...
    const updatePlayerData = async (data) => {
        const req = await fetch("https://8zipmwvvhl.execute-api.ap-south-1.amazonaws.com/CoachLife/player", {
            method: 'post',
        ...
        <div>
            ...
            <m.section className="py-[120px] lg:py-[120px] md:py-[75px] sm:py-[50px] xs:py-[80px] xxs:py-[50px]"  {...fadeIn}>
                <Container>
                    <Row>
                        <Col className='mb-[6%]'>
                            <h6 className="font-serif text-gray-500 text-center font-medium mb-[25px] lg:mb-[15px]">New Player</h6>
                        </Col>
                    </Row>
                        ...
                        <Col>
                            <Formik
                                ...
                                onSubmit={async (values, actions) => {
                                    ...
                                    response.message === 'Player data inserted successfully.' && resetForm(actions)
                                }}
                            >
                                {({ isSubmitting, status }) => (
                                    <Form>
                                        <Row className="row-cols-1 row-cols-md-2">
                                            <Col className="mb-16 lg:mb-[25px] sm:mb-0">
                                                ...
                                                <Input showErrorMsg={false} type="date" name="dateOfBirth" className="py-[15px] px-[20px] w-full text-md border-[1px] border-solid border-[#dfdfdf]" labelClass="mb-[25px]" placeholder="Select Date of Birth" />
                                                <Input showErrorMsg={false} type="text" name="bloodGroup" className="py-[15px] px-[20px] w-full text-md border-[1px] border-solid border-[#dfdfdf]" labelClass="mb-[25px]" placeholder="Blood group" />
                                            ...
                                            <Col className="text-right sm:text-center">
                                                <Buttons ariaLabel="form button" type="submit" className={`text-xs tracking-[1px] rounded-none py-[12px] px-[28px] uppercase${isSubmitting ? " loading" : ""}`} themeColor={["#556fff", "#ff798e"]} size="md" color="#fff" title="Create Player" />
                                            </Col>
                                        </Row>
                                        <AnimatePresence>
